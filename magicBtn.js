  ...
  return (
    <div ref={scope}>
      <button
        ...
        className="relative inline-flex rounded-full border-2 border-blue-600 px-6 py-2 text-2xl text-blue-600 transition-colors hover:bg-slate-950"
      >
       <span className="sr-only">Magic</span>
        <span className="block h-8 overflow-hidden" aria-hidden>

          
          {["M", "a", "g", "i", "c"].map((letter, index) => (
            <span
              data-letter={letter}
